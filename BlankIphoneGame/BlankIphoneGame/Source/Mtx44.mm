...
namespace Math
{
  ...
  {
    float scale  = tan(DegreeToRadian(fovDegree * .5f)) * nearPlane;
    float right  = aspect * scale;
    float left   = -right;
    float top    = scale;
    float bottom = -top;
    
    result.m[0][0] = 2 * nearPlane / (right - left);
    result.m[0][1] = 0;
    result.m[0][2] = 0;
    result.m[0][3] = 0;
    
    result.m[1][0] = 0;
    result.m[1][1] = 2 * nearPlane / (top - bottom);
    result.m[1][2] = 0;
    result.m[1][3] = 0;
                      ...
                      float bottom, float nearPlane, float farPlane)
  {
    ...
    result.m[2][0] = 0;
    result.m[2][1] = 0;
    result.m[2][2] = -2.f / (farPlane - nearPlane);
    result.m[2][3] = 0;
                     ...
                     const Vec2D& /*up*/)
  {
    ...
    result.m[3][0] = -cameraPos.x;
    result.m[3][1] = -cameraPos.y;
    result.m[3][2] = -cameraDistance;
    result.m[3][3] = 1;
  }
  /******************************************************************************/
  /*!
